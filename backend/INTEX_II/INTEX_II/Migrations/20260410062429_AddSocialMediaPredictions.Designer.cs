...
namespace INTEX_II.Migrations
{
    ...
    [Migration("20260410062429_AddSocialMediaPredictions")]
    partial class AddSocialMediaPredictions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("INTEX_II.Models.SocialMediaPrediction", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("integer")
                        .HasColumnName("post_id");

                    b.Property<string>("DonationTier")
                        .HasColumnType("text")
                        .HasColumnName("donation_tier");

                    b.Property<string>("PredictedEngagementTier")
                        .HasColumnType("text")
                        .HasColumnName("predicted_engagement_tier");

                    b.Property<int?>("PredictedHasDonations")
                        .HasColumnType("integer")
                        .HasColumnName("predicted_has_donations");

                    b.Property<DateTime>("PredictionTs")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("prediction_ts");

                    b.Property<double?>("ProbEngagementHigh")
                        .HasColumnType("double precision")
                        .HasColumnName("prob_engagement_high");

                    b.Property<double?>("ProbEngagementLow")
                        .HasColumnType("double precision")
                        .HasColumnName("prob_engagement_low");

                    b.Property<double?>("ProbEngagementMedium")
                        .HasColumnType("double precision")
                        .HasColumnName("prob_engagement_medium");

                    b.Property<double>("ProbHasDonations")
                        .HasColumnType("double precision")
                        .HasColumnName("prob_has_donations");

                    b.HasKey("PostId")
                        .HasName("pk_social_media_predictions");

                    b.ToTable("social_media_predictions", (string)null);
                });
            ...
            modelBuilder.Entity("INTEX_II.Models.SocialMediaPrediction", b =>
                {
                    b.HasOne("INTEX_II.Models.SocialMediaPost", null)
                        .WithOne()
                        .HasForeignKey("INTEX_II.Models.SocialMediaPrediction", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_social_media_predictions_social_media_posts_post_id");
                });
